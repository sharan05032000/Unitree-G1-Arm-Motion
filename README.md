...
2. **Clone this repository:**
   ```bash
   git clone https://github.com/sharan05032000/Unitree-G1-Arm-Manipulation.git
   ```
...
- You can generate similar MoveIt configurations for other arms using **MoveIt Setup Assistant**.
